/**
 * DataOverrideService that extends DataService with method overrides.
 */
...
import { getStatusText, STATUS } from '../constants/http-status-codes';
...
@Injectable()
export class DataOverrideService extends DataService {
  ...
  genId<T extends { id: any }>(collection: T[], collectionName: string): any {
    if (collectionName === 'homebuildversions') {
      console.log('genId override for \'homebuildversions\'');
      return guid();
    } else if (collection) {
